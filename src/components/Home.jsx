    ...
    <main className=" container">
      <section className="flex container hero-section">
        <div className="right-header flex">
          ...
          <p>Welcome to Thapa eComStore, your ultimate destination for cutting-edge gadgets! Explore the latest in tech
            innovation and style with us. Shop now and discover a world of possibilities!</p>
          <button className="flex" onClick={() => navigate('/product')} >Expolre Our Products <i
            className="fa-solid fa-arrow-right"></i></button>
        </div>
        <div className="left-header">
          <img src="https://jscourse.csscourse.online/assets/heroSection-Cr4Kp07R.svg" alt="" />
        </div>
      </section>
      <div className="custom-shape-divider-bottom-1753530860">
